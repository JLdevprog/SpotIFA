...
<nav id="menu">
	...
	<ul>
		...
		<li><a class="menu_bouton" href="./page/playlist_page.php">Playlist</a></li>
		<li><a class="menu_bouton" href="./page/other_page.php">Other</a></li>
		<li><a id="menu_log" class="menu_bouton" href="./page/Log_page.php">
			<img src="./library/loger.png" height="50" width="50" ><br>Log</a></li>
	</ul>
